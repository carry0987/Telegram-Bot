...
const config: Config = {
    title: 'Telegram-Bot',
    tagline: 'Go Telegram bot starter with polling, webhook, session demos, and health probes.',
        ...
        [
            '@docusaurus/preset-classic',
            {
                ...
                docs: {
                    ...
                    editUrl: 'https://github.com/carry0987/Telegram-Bot/tree/master/',
                },
                theme: {
    ...
    themeConfig: {
        navbar: {
            ...
            items: [
                ...
                {
                    href: 'https://github.com/carry0987/Telegram-Bot',
                    label: 'GitHub',
                    position: 'right',
                },
                {
        ...
        footer: {
            style: 'dark',
            copyright: `Copyright © ${new Date().getFullYear()} carry0987. Telegram-Bot docs built with Docusaurus.`,
        },
        colorMode: {
            defaultMode: 'light',
            disableSwitch: false,
